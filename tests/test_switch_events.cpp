...
void test_update_switch_event_stable_idle()
{
    ...
    assert(sw_event.event_type == mkeybo::SwitchEventType::idle);
...
void test_update_switch_event_idle_press_release()
{
    ...
    assert(sw_event.event_type == mkeybo::SwitchEventType::pressed);
    assert(sw_event.released == 0);
    ...
    // 3. cycle
    generator.update_switch_event(k_settings, false, sw_event);
    assert(sw_event.event_type == mkeybo::SwitchEventType::released);
    ...
    // 5. cycle
    generator.update_switch_event(k_settings, false, sw_event);
    assert(sw_event.event_type == mkeybo::SwitchEventType::tap_dance_end);
    assert(sw_event.released == 0);
    assert(sw_event.pressed == 0);
    assert(sw_event.tap_dance == 1);
    assert(sw_event.hold == false);
...
void test_update_switch_event_max_pressed_counter()
{
    ...
    mkeybo::SwitchEvent sw_event{
        ...
        .released = 0,
        .hold = true,
        .event_type = mkeybo::SwitchEventType::pressed
    };
    mkeybo::SwitchEventsGenerator<switches_count> generator;
    // -1 cycle
    generator.update_switch_event(k_settings, true, sw_event);
...
void test_update_switch_event_keyboard_state()
{
    ...
    assert(keyboard_state.switch_events[0].event_type == mkeybo::SwitchEventType::idle);
    assert(keyboard_state.switch_events[1].event_type == mkeybo::SwitchEventType::idle);
    // cycle 1
    ...
    assert(keyboard_state.switch_events[1].event_type == mkeybo::SwitchEventType::pressed);
